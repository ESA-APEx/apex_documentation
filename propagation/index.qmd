...
The vision for the ESA APEx initiative is adopt FAIR data principles and ensure that project results remain Findable and Accessible and that they become Interoperable and Reusable. For value added products, this mainly involves ingestion in an ESA controlled persistent storage solution and exposing these products accordingly (using STAC and other technologies).
...
Thanks to this APEx compliant cloud service implementation option, your software is packaged using Docker containers and CWL (Common Workflow Language) wrappers, together forming an OGC Application Package.
