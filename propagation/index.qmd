...
The algorithm propagation support provided by APEx involves various subcomponents, and their relevance depends on a
...
* Onboarding and integration of a service into the APEx Algorithm Services Catalogue
...
This support can also be visualised in a chart, illustrated in @fig-pathway. APEx Propagation Pathways. This chart
outlines the different pathways for projects to transform and optimise their algorithms into on-demand services using
the APEx propagation services.

The main goal of the propagation services is to guide projects in defining their pathway and providing support
...
```{mermaid}
%%| label: fig-pathway
%%| fig-cap: "APEx Propagation Pathways"
flowchart TD ""
    subgraph Legend
