...
without having to worry about IT aspects such as security, backup or monitoring the service. The catalog supports
creating both private and public collections.

#### Key Considerations

* **Data storage**: The STAC catalog does _not_ include data storage. It is recommended to request object storage access
...
* **Software**: The catalog is powered
...
In addition to the STAC Catalog API, APEx provides a dedicated STAC Browser to support the visual exploration of your
