...
The Python client has a convenience function called [`spatial_extent`](https://open-eo.github.io/openeo-python-client/api.html#openeo.api.process.Parameter.spatial_extent) to create this parameter when building your UDP via Python.
