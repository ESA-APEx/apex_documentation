...
are made to increase uniformity across the [APEx Algorithm Catalogue](https://algorithms-catalogue.apex.esa.int/).
...
Next, you will need to upload a generic JSON to the [APEx Algorithm Catalogue](https://algorithms-catalogue.apex.esa.int/) to register your process. For now, this is
