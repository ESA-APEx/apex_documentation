...
This lists the names, but we are more interested in a more convenient overview of all properties. The library for instance
allows to construct a pandas DataFrame with all properties:
